(** Testing
    ...
    Dependencies: src/proto_112_Pt4FJEL6/lib_protocol/script_interpreter.ml
    Invocation:   dune exec src/proto_112_Pt4FJEL6/lib_protocol/test/main.exe -- test "^interpretation$"
