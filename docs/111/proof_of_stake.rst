...
The :ref:`randomness<random_seed_111>` is obtained from information already found on the
...
:ref:`protocol constant <protocol_constants_111>`.
...
The seed of the PRNG is the :ref:`random seed <random_seed_111>` associated with cycle ``n-PRESERVED_CYCLES``.
